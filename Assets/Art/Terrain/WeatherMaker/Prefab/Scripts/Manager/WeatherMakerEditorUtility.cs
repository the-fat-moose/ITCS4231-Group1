...
namespace DigitalRuby.WeatherMaker
{
    ...
    public static class WeatherMakerEditorUtility
    {
        ...
        public static void UpdatePreProcessor(bool add, string preProcessor, string newPreprocessor = null)
        {
            ...
            string currentDefinesString = UnityEditor.PlayerSettings.GetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(UnityEditor.EditorUserBuildSettings.selectedBuildTargetGroup));
#else
...
#if UNITY_6000_0_OR_NEWER
                UnityEditor.PlayerSettings.SetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(UnityEditor.EditorUserBuildSettings.selectedBuildTargetGroup), newDefinesString);
#else
